...
import { CLASSIC_INJECTION_VECTORS, MALICIOUS_FIELD_PAYLOADS } from './injection-vectors.js';
...
`;
    ...
    describe('Data API Endpoint Security', () => {
        ...
        test('should protect DELETE endpoint against injection in ID parameters', async () => {
            ...
            const deleteResult = await testContext.database.deleteAll('apitest', records.map(r => ({ id: r.id })));
...
//# sourceMappingURL=api-endpoint-injection.test.js.map