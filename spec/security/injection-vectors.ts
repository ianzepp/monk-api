 ...
 */
export const CLASSIC_INJECTION_VECTORS: InjectionVector[] = [
    {
 ...
 */
export const POSTGRESQL_INJECTION_VECTORS: InjectionVector[] = [
    {
 ...
 */
export const ADVANCED_INJECTION_VECTORS: InjectionVector[] = [
    {
 ...
 */
export const ENCODING_INJECTION_VECTORS: InjectionVector[] = [
    {
 ...
 */
export const EVASION_INJECTION_VECTORS: InjectionVector[] = [
    {
 ...
 */
export function getAllInjectionVectors(): InjectionVector[] {
    return [
 ...
 */
export function getInjectionVectorsByCategory(category: string): InjectionVector[] {
 ...
 */
export function getInjectionCategories(): string[] {
