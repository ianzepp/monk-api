...
import { createTestContextWithFixture, createMultiFixtureContext, TestContextWithData, TestTenantManager } from '../helpers/test-tenant.js';
describe('Enhanced Test Helpers - Phase 4 Examples', () => {
    ...
    describe('Test Assertions and Validation', () => {
        ...
        test('should support assertion helpers', async () => {
            ...
            await expect(testContext.helpers.assertRecordExists('account', {
                email: 'nonexistent@test.com'
            })).rejects.toThrow('Expected record not found');
            await expect(testContext.helpers.assertRecordCount('account', 999)).rejects.toThrow('Expected 999 records');
        });
    });
...
//# sourceMappingURL=enhanced-test-helpers.test.js.map