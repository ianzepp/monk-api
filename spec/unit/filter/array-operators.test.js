...
describe('PostgreSQL Array Operators - Comprehensive Testing', () => {
    ...
    describe('Performance and Optimization', () => {
        ...
        test('array operations with soft delete filtering', () => {
            const { whereClause, params } = FilterWhere.generate({ access_read: { $any: ['user-123'] } }, 0, { includeTrashed: false, includeDeleted: false });
        ...
        test('array operations with soft delete included', () => {
            const { whereClause, params } = FilterWhere.generate({ access_read: { $any: ['user-123'] } }, 0, { includeTrashed: true, includeDeleted: true });
...
//# sourceMappingURL=array-operators.test.js.map