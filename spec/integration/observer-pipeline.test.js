...
describe('Observer Pipeline Integration', () => {
    ...
    describe('User Creation Pipeline', () => {
        test('should execute validation, business logic, and integration observers for user creation', async () => {
            ...
            const result = await runner.execute(mockSystem, 'create', 'user', userData);
    ...
    describe('Account Update Pipeline', () => {
        test('should validate balance changes and track metadata', async () => {
            ...
            const result = await runner.execute(mockSystem, 'update', 'account', updateData, 'account-123', existingAccount);
            expect(result.success).toBe(true);
    ...
    describe('Universal Observers', () => {
        test('should apply universal observers to all schemas', async () => {
            ...
            const userResult = await runner.execute(mockSystem, 'create', 'user', { email: 'user@test.com', name: 'User' });
            // Test with account schema  
            const accountResult = await runner.execute(mockSystem, 'create', 'account', { name: 'Test Account', balance: 100 });
...
//# sourceMappingURL=observer-pipeline.test.js.map