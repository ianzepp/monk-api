...
import type { FtpStoreRequest, FtpStoreResponse } from '@src/routes/ftp/store.js';
import type { FtpDeleteRequest, FtpDeleteResponse } from '@src/routes/ftp/delete.js';
...
describe('FTP File Operations - Integration Tests (Phase 3)', () => {
    ...
    describe('FTP Store Operations', () => {
        test('should create new record via FTP store', async () => {
            const storeRequest: FtpStoreRequest = {
            ...
            const result: FtpStoreResponse = await response.json();
    ...
    describe('FTP Delete Operations', () => {
        test('should soft delete a record', async () => {
            ...
            const deleteRequest: FtpDeleteRequest = {
            ...
            expect(response.status).toBe(200);
            const result: FtpDeleteResponse = await response.json();
    ...
    describe('Performance and Metadata', () => {
        ...
        test('should generate consistent ETags for same content', async () => {
            ...
            // First store
            const storeRequest1: FtpStoreRequest = {
            ...
            const result1: FtpStoreResponse = await response1.json();
            
            // Second store with same content
            const storeRequest2: FtpStoreRequest = {
            ...
            const result2: FtpStoreResponse = await response2.json();
