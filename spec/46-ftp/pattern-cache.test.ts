...
describe('PatternCache - Pattern Caching System', () => {
    ...
    describe('Basic Cache Operations', () => {
        test('should cache and retrieve pattern translation', () => {
            ...
            const translation: WildcardTranslation = {
                schemas: ['users'],
    ...
    describe('Schema-Based Invalidation', () => {
        test('should invalidate patterns by schema', () => {
            ...
            const userTranslation: WildcardTranslation = {
                schemas: ['users'],
                filter: { where: { id: { $like: 'admin%' } } },
                cross_schema: false,
                complexity: 'simple',
            ...
            const accountTranslation: WildcardTranslation = {
                schemas: ['accounts'],
            ...
            const productTranslation: WildcardTranslation = {
                schemas: ['products'],
    ...
    describe('Memory Management and Capacity', () => {
        test('should enforce maximum entries limit with LRU eviction', () => {
            ...
            const baseTranslation: WildcardTranslation = {
                schemas: ['test'],
