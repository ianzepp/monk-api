...
# Record stat
record_stat=$(file_stat "/data/account/$ACCOUNT_ID")
validate_file_metadata "$record_stat" "directory" "Account record"
validate_record_info "$record_stat" "account" "$ACCOUNT_ID" "Account record"
...
size_response=$(file_size "/data/account/$ACCOUNT_ID")
...
modify_response=$(file_modify_time "/data/account/$ACCOUNT_ID")
