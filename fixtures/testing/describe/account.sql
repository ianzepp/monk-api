...
INSERT INTO schemas (schema_name, status) VALUES ('account', 'active');
...
INSERT INTO columns (schema_name, column_name, type, required, default_value, description, minimum, maximum)
