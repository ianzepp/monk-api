...
export default class RecordPreloader extends BaseObserver {
     ...
     */
    static getPreloadedRecords(context: PipelineContext): readonly any[] {
     ...
     */
    static getPreloadedRecordsById(context: PipelineContext): Readonly<Record<string, any>> {
     ...
     */
    static hasPreloadError(context: PipelineContext): boolean {
     ...
     */
    static getPreloadStats(context: PipelineContext): {
