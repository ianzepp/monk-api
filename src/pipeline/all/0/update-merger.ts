...
export default class UpdateMerger extends BaseObserver {
     ...
     */
    static wasRecordMerged(context: PipelineContext, recordId: string): boolean {
     ...
     */
    static getRecordMergeDetails(context: PipelineContext, recordId: string): any | null {
        const mergeDetails = context.metadata.get('merge_details') || [];
     ...
     */
    static getMergeStats(context: PipelineContext): {
        wasMerged: boolean;
        mergedCount: number;
        skippedCount: number;
