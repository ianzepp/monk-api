...
import { SystemError, ValidationWarning } from '@src/lib/pipeline/errors.js';
...
export default class WebhookSender extends BaseAsyncPipeline {
    readonly ring = PipelineRing.Integration;
    ...
    private async sendWebhook(endpoint: WebhookEndpoint, context: PipelineContext): Promise<any> {
    ...
    private async retryWebhook(endpoint: WebhookEndpoint, context: PipelineContext, lastError: any): Promise<any> {
    ...
    private createWebhookPayload(context: PipelineContext): any {
