...
export default class ExistenceValidator extends BaseObserver {
    readonly ring = PipelineRing.Security;
     ...
     */
    static recordExists(context: PipelineContext, recordId: string): boolean {
     ...
     */
    static getExistingRecord(context: PipelineContext, recordId: string): any | null {
        const recordsById = RecordPreloader.getPreloadedRecordsById(context);
     ...
     */
    static getValidationStats(context: PipelineContext): {
