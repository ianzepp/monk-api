 ...
 *
 * Converts complex FS patterns to database filters with performance optimization.
 * Leverages enhanced Filter operators for sophisticated query generation.
 */
export class WildcardTranslator {
    /**
     * Main translation method - converts FS wildcard path to database filter
     *
     * @param filePath - FS path with wildcards
     * @returns Translation with filter, complexity info, and optimization details
     */
    static translatePath(filePath: string): WildcardTranslation {
     ...
     */
    private static extractWildcardPattern(
        pattern: string,
        startIndex: number
    ): {
        pattern: string;
     ...
     */
    private static extractAlternativePattern(
        pattern: string,
        startIndex: number
    ): {
        pattern: string;
     ...
     */
    private static extractRangePattern(
        pattern: string,
        startIndex: number
    ): {
        pattern: string;
