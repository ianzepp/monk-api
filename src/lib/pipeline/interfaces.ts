...
import type { ValidationError, ValidationWarning } from '@src/lib/pipeline/errors.js';
...
export interface Pipeline {
     ...
     */
    executeTry(context: PipelineContext): Promise<void>;
...
/**
 * Pipeline class constructor interface for dynamic loading
 */
...
/**
 * Pipeline execution statistics for monitoring
 */
...
/**
 * Pipeline execution summary for a complete operation
 */
