 ...
 */
export class SecurityError extends PipelineError {
 ...
 */
export class SystemError extends PipelineError {
...
/**
 * Pipeline timeout error - thrown when observer execution exceeds time limit
 */
export class PipelineTimeoutError extends SystemError {
...
/**
 * Pipeline recursion limit exceeded error
 */
export class PipelineRecursionError extends SystemError {
    public readonly depth: number;
    public readonly maxDepth: number;

    constructor(depth: number, maxDepth: number) {
        super(`Pipeline recursion limit exceeded (${depth} > ${maxDepth})`, undefined, 'OBSERVER_RECURSION_LIMIT');
        this.depth = depth;
