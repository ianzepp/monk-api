...
export { default as RecordGet } from '@src/routes/api/data/:model/:record/GET.js';
export { default as RecordPut } from '@src/routes/api/data/:model/:record/PUT.js';
export { default as RecordDelete } from '@src/routes/api/data/:model/:record/DELETE.js';
...
export { default as NestedRecordGet } from '@src/routes/api/data/:model/:record/:relationship/:child/GET.js';
export { default as NestedRecordPut } from '@src/routes/api/data/:model/:record/:relationship/:child/PUT.js';
export { default as NestedRecordDelete } from '@src/routes/api/data/:model/:record/:relationship/:child/DELETE.js';
