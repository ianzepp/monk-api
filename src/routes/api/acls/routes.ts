...
export { default as RecordAclGet } from '@src/routes/api/acls/:schema/:record/GET.js';
export { default as RecordAclPost } from '@src/routes/api/acls/:schema/:record/POST.js';
export { default as RecordAclPut } from '@src/routes/api/acls/:schema/:record/PUT.js';
export { default as RecordAclDelete } from '@src/routes/api/acls/:schema/:record/DELETE.js';
