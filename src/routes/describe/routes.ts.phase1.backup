...
export { default as SchemaGet } from '@src/routes/meta/:schema/GET.js';
export { default as SchemaPost } from '@src/routes/meta/:schema/POST.js';
export { default as SchemaPut } from '@src/routes/meta/:schema/PUT.js';
export { default as SchemaDelete } from '@src/routes/meta/:schema/DELETE.js';
