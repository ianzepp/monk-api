...
describe('Fixture System Phase 2', () => {
    ...
    describe('FixtureManager', () => {
        ...
        test('should handle missing fixture definition', async () => {
            await expect(FixtureManager.loadFixtureDefinition('nonexistent')).rejects.toThrow('Fixture definition not found');
        });
    });
...
//# sourceMappingURL=fixture-system-phase2.test.js.map