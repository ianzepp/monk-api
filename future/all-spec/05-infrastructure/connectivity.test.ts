...
import { createTestTenant, createTestContext, testDatabaseConnectivity, testMetabaseConnectivity, type TestTenantManager, type TestContext } from '../helpers/test-tenant.js';
...
describe('05-infrastructure: Basic Connectivity', () => {
    ...
    describe('Metabase Connectivity', () => {
        ...
        test('should retrieve schema definition as YAML', async () => {
            const schemaYaml = await testContext.metabase.selectOne('schemas');
